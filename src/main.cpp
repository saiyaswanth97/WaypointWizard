...
#include <random>
#include <cmath>
double MIN_X = 0.0, MAX_X = 10.0, MIN_Y = 0.0, MAX_Y = 10.0;
double START_X = 2.5, START_Y = 3.5, END_X = 5.5, END_Y = 7.5;
double STEP_SIZE = 0.7, NEIGHBOUR_RADIUS = 1.9, GOAL_THRES=1.0;
